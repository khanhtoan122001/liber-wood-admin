...
const CollectionView = () => {
    ...
    useEffect(() => {
      dispatch(getCollection(parseInt(id)))
    }, [dispatch])

    return store.selectedCollection !== null && store.selectedCollection !== undefined ? (
      <div className='app-user-view'>
        <Row>
          <Col xl='4' lg='5' xs={{ order: 1 }} md={{ order: 0, size: 5 }}>
            <CollectionCard selected={store.selectedCollection} />
            {/* <PlanCard /> */}
          </Col>
